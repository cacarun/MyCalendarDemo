...
import static com.test.calendar.CalendarUtil.getDayOfWeek;
...
public class CalendarFactory {
    ...
    public static List<CalendarBean> getMonthOfDayList(int y, int m) {
        ...
        for (int i = fWeek - 1; i > 0; i--) {
            ...
            bean.monthFlag = CalendarBean.MONTH_FLAG.BEFORE;

            // test
            bean.dayFlag = CalendarBean.DAY_FLAG.BACKUP;
        ...
        for (int i = 0; i < total; i++) {
            ...
            // test
            bean.dayFlag = CalendarBean.DAY_FLAG.WORK;
        ...
        for (int i = 0; i < 42 - (fWeek - 1) - total; i++) {
            ...
            bean.monthFlag = CalendarBean.MONTH_FLAG.AFTER;

            // test
            bean.dayFlag = CalendarBean.DAY_FLAG.REST;
